  ...
  return (
    <section className="fade-rise relative left-1/2 right-1/2 -mx-[50vw] min-h-screen w-screen overflow-hidden text-white">
      ...
      <div className="relative mx-auto flex w-full max-w-7xl items-center justify-center px-4 py-16 sm:px-6 lg:px-8">
        <div className="w-full max-w-lg rounded-2xl border border-white/20 bg-[#0a1e35]/75 p-6 shadow-2xl backdrop-blur-sm sm:p-8">
          <h1 className="text-2xl font-bold text-white [font-family:var(--font-headline)]">Create Account</h1>
          <RegisterForm />
        </div>
      </div>
    </section>
